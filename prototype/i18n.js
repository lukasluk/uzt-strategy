(function () {
  ...
  const EXACT_TEXT_EN = new Map([
    ...
    ['Strateginiai rysiai', 'Strategic links'],
    ['Rysiai', 'Links'],
  ...
  const RULES_EN = [
    ...
    [/^Strateginiai rysiai:\s*/u, 'Strategic links: '],
    [/^Rysiai:\s*/u, 'Links: '],
    [/^Strateginiai rysiai tarp teviniu gairiu$/u, 'Strategic links between parent guidelines'],
